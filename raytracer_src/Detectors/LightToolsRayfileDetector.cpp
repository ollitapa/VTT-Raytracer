...
AbstractGeometry* LightToolsRayfileDetector::receiveRay(Ray& ray,
  ...
  arma::uvec idx = arma::sort_index(
      arma::abs(*_wavelengths - ray.wavelength_0));
...
void LightToolsRayfileDetector::tracerDidEndTracing() {
  ...
  f.write((char*) &(_cumulativeRadiantPower), 4);  // Some Float. Cumulative radiant power apparently.
