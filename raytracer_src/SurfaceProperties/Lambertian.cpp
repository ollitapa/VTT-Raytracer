...
Lambertian::Lambertian() {
  _hierarchy = HIERARCHY_DIFFUSE_LAMBERTIAN;
  _cooperation_level = COOPERATION_LEVEL_DIFFUSE_LAMBERTIAN;
}

Lambertian::Lambertian(Json::Value jsonData) {
  _hierarchy = HIERARCHY_DIFFUSE_LAMBERTIAN;
  _cooperation_level = COOPERATION_LEVEL_DIFFUSE_LAMBERTIAN;
}

AbstractGeometry* Lambertian::receiveRay(Ray& ray, Surface* surface,
